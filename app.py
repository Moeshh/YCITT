...
def rooster(group):
    ...
    class_select = '<label for="class">Choose a class:</label><select onchange="val()" name="class" id="SelectClass">'
    trainer_select = '<label for="trainer">Choose a Trainer:</label><select onchange="val()" name="trainer" id="SelectTrainer">'
